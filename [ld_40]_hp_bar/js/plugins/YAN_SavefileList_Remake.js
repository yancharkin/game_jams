...
Window_SavefileList.prototype.drawItem = function(index) {
    ...
    if (index == 0) {
        this.drawText('__________________________________________________', 0, rect.y-24, 0);
    }
    this.drawText('__________________________________________________', 0, rect.y+57, 0);
};
