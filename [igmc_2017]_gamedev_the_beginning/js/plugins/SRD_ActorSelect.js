 ...
 * !NB Modified by yancharkin: position of some elements changed.
 * @author SumRndmDde
 *
...
(function(_) {
	...
	Window_ActorSelect.prototype.drawItemImage = function(index) {
	    ...
	    var width2 = 284;
            ...
            if(_.drawClass) this.drawActorClass(actor, x, y + lineHeight * 1);
            if(_.drawLevel) this.drawActorLevel(actor, x, y + lineHeight * 2);
            if(_.drawIcons) this.drawActorIcons(actor, x2, y);
